...
export const metadata: Metadata = {
    title: "Industries We Serve — Startups, SaaS, Finance, Healthcare",
    description:
        "Sector-specific AI implementations for startups, SaaS, financial services, healthcare, manufacturing, and logistics. Compliance-aware, industry-tuned delivery.",
    keywords: ["AI for startups", "AI for SaaS", "AI healthcare", "AI financial services", "AI manufacturing", "AI logistics"],
    alternates: { canonical: "/industries" },
    openGraph: {
        title: "Industries We Serve — AI Solutions by Sector",
        description: "Sector-specific AI implementations that account for industry-specific constraints, compliance, and competitive dynamics.",
        url: "/industries",
        type: "website",
    },
};
export default async function IndustriesPage() {
    ...
    return (
        <div className="relative">
            {/* ── SEO: Structured Data ── */}
            <JsonLd data={getItemListSchema("Industries Served by KraftCoder", INDUSTRIES.map(i => ({
                name: i.title,
            ...
            <section className="section-padding bg-background relative overflow-hidden border-t border-white/4 section-glow">
                ...
                <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="mt-10">
                        <Link href="/contact" className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/4 px-8 py-4 text-sm font-semibold text-zinc-300 hover:bg-primary hover:border-primary hover:text-white transition-all">
